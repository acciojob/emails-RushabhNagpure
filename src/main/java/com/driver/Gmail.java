...
public class Gmail extends Email {
    ...
    public String findLatestMessage(){
        ...
        return Inbox.get(Inbox.size() - 1).getRight(); // Inbox.size - 1 is means last msg of index list
    }
    ...
    public String findOldestMessage(){
        ...
        if(Inbox.isEmpty())
            return null;
        return Inbox.get(0).getRight(); // 0 it means msg is present at 1st position
